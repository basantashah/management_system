...
title = Label(entries_frame, text="Employee Management System", font=("Calibri", 45, "bold"), bg="#535c68", fg="white")
...
txtAddress = Text(entries_frame, width=30, height=1, font=("Calibri", 16))
...
tree_frame.place(x=0, y=390, width=1366, height=520)
style = ttk.Style()
