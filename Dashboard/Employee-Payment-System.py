...
root = Tk()
root.title("Employee Payment Chart")
...
Tops = Frame(root, width=1350, height=50, bd=8, bg="#16a085")
Tops.pack(side=TOP)

f1 = Frame(root, width=600, height=600, bd=8, bg="#2c3e50")
f1.pack(side=LEFT)
f2 = Frame(root, width=300, height=700, bd=8, bg="#16a085")
f2.pack(side=RIGHT)

fla = Frame(f1, width=600, height=200, bd=8, bg="#16a085")
fla.pack(side=TOP)
flb = Frame(f1, width=300, height=600, bd=8, bg="#16a085")
flb.pack(side=TOP)

lbl_information = Label(Tops, font=('arial', 55, 'bold'), text="Employee Payment Chart ", relief=GROOVE,  bd=10, bg="#2c3e50", fg="white")
...
labelFirstName = Label(fla, text="Full Name", font=('arial', 16, 'bold'), bd=20, fg="white", bg="#16a085").grid(row=0, column=0)

labelAddress = Label(fla, text="Home Address", font=('arial', 16, 'bold'), bd=20, fg="white", bg="#16a085").grid(row=0, column=2)

labelCompanyAgency = Label(fla, text="Company/Agency", font=('arial', 16, 'bold'), bd=20, fg="white", bg="#16a085").grid(row=1,
                                                                                                              column=0)
labelPhoneNumber = Label(fla, text="Phone Number", font=('arial', 16, 'bold'), bd=20, fg="white", bg="#16a085").grid(row=1,
                                                                                                               column=2)
labelHoursWorked = Label(fla, text="Hours Worked", font=('arial', 16, 'bold'), bd=20, fg="white", bg="#16a085").grid(
    row=2, column=0)
labelHourlyRate = Label(fla, text="Hourly Rate", font=('arial', 16, 'bold'), bd=20, fg="white", bg="#16a085").grid(
    row=2, column=2)
labelTax = Label(fla, text="Tax", font=('arial', 16, 'bold'), bd=20, anchor='w', fg="white", bg="#16a085").grid(row=3,
                                                                                                                column=0)
labelOverTime = Label(fla, text="OverTime", font=('arial', 16, 'bold'), bd=20, fg="white", bg="#16a085").grid(row=3,
                                                                                                              column=2)
labelGrossPay = Label(fla, text="GrossPay", font=('arial', 16, 'bold'), bd=20, fg="white", bg="#16a085").grid(row=4,
                                                                                                              column=0)
labelNetPay = Label(fla, text="Net Pay", font=('arial', 16, 'bold'), bd=20, fg="white", bg="#16a085").grid(row=4,
                                                                                                           column=2)
...
payslip = Label(f2, textvariable=DateOfOrder, font=('arial', 21, 'bold'), fg="white", bg="#16a085").grid(row=0,
                                                                                                           column=0)
